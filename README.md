...
Generating maps for a 2D platformer.

---

## WHAT IS THE PURPOSE OF THIS PROJECT ?

To provide a n easy to use tool to generate maps for a 2D platformer.

---

## WHO IS THIS REPOSITORY FOR ?

Anyone who wishes to make a level for a 2D platformer game.
