...
6. Constants must always be in UPPER-CASE.
7. Local variables must be in lower-case prefixed with and _underscore.
8. ternary operator `cond ? a : b` should be used where the check is concise.
9. Allman style must be used. APL can be used for short one-liners.
10. Remember to mark functions with @pure and @void where applicable.
